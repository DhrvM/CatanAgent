...
export const BENCHMARK_TASKS = [
  ...
  },
  {
    ...
    category: 'earlyGame',
    difficulty: 'strategic',
    description: 'Select the best opening road direction for expansion.',
  },
  {
  ...
  },
  {
    ...
    category: 'opponentInteraction',
    difficulty: 'strategic',
    description: 'Evaluate incoming trades against self-interest and table state.',
  },
  {
    ...
    description: 'Construct a trade offer that advances the agent without aiding leaders.',
  },
  {
